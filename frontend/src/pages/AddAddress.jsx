      ...
      <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
            <div className='flex-1 max-w-md'>
                <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                    ...
                    <InputField handleChange={handleChange}
                    address={address} name='email' type='text' placeholder='Email' />
                    <InputField handleChange={handleChange}
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                        <InputField handleChange={handleChange}
                        address={address} name='zipcode' type='text' placeholder='Zip code' />
                        <InputField handleChange={handleChange}
                    ...
                    <InputField handleChange={handleChange}
                    address={address} name='phone' type='text' placeholder='Phone No.' />

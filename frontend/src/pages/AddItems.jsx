            ...
            <form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <div className="flex items-center gap-5 flex-wrap">
                    <div className="flex-1 flex flex-col gap-1 w-32">
                        <label className="text-base font-medium" htmlFor="product-price">Product Price Per Day</label>
                        <input onChange={(e)=>setPricePerDay(e.target.value)} value={priceperday}
                    ...
                    <div className="flex-1 flex flex-col gap-1 w-32">
                        <label className="text-base font-medium" htmlFor="offer-price">Deposit</label>
                        <input onChange={(e)=>setDeposit(e.target.value)} value={deposit}
                         id="offer-price" type="number" placeholder="0" className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40" required />
                    </div>
                </div>
                <button className="px-8 py-2.5 bg-primary text-white cursor-pointer font-medium rounded">ADD</button>
            </form>
        </div>
  )
}
